...
uniform vec4 u_terrainTex1UVTransform;
varying vec2 v_terrainTex1UV;
#endif

#ifdef terrainTex2Flag
uniform vec4 u_terrainTex2UVTransform;
varying vec2 v_terrainTex2UV;
#endif

#ifdef terrainTex3Flag
uniform vec4 u_terrainTex3UVTransform;
varying vec2 v_terrainTex3UV;
#endif
