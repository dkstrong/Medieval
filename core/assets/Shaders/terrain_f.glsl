...
void main() {
	...
	texColor4 = (1.0) -texColor4;
	//texColor4 = texColor4 * vec4(0.5,0.5,0.5,1.0);
	vec4 texColor3Dark = texColor3 * vec4(0.0,0.0,1.0,1.0);
	...
	m_regionWeight = (m_regionRange - abs(height - m_regionMax)) / m_regionRange;
	m_regionWeight = max(0.0, m_regionWeight);
	vec4 temp = texColor4 * m_regionWeight *0.025;
	//temp.a =1.0;
	weightedColor += temp;


	diffuse = weightedColor;
